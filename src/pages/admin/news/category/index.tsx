...
import { headerItemNewsCateogries, styleActive, styleNotActive } from '@/helpers/resource/table-admin'
...
import { deleteNewsCategory, useGetNewsCategories } from '@/service/admin/news-category'

function GetNewsCategorySwr() {
    ...
    async function handleDelete(id: string) {
        const result = await deleteNewsCategory(id, token)
        if (result.code !== 200) {
