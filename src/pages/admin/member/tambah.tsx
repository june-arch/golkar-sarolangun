...
const Tambah = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            photo: Yup.mixed().test("fileSize", "The file is too large", checkIfFilesAreTooBig).test("fileType", "The file type invalid", checkIfFilesAreCorrectType).required(),
            photo_ktp: Yup.mixed().test("fileSize", "The file is too large", checkIfFilesAreTooBig).test("fileType", "The file type invalid", checkIfFilesAreCorrectType).required(),
    ...
    const listCategory = regions.data.map((item) => { return { label: item.name, value: item.id_regional } })
    return (
        <Layout>
