...
import { useRegionDeleteAdminQuery, useRegionsAdminQuery } from '@/helpers/hooks/react-query/use-region';
...
const Index = () => {
  ...
  const mutation = useRegionDeleteAdminQuery();
  ...
  const result = useRegionsAdminQuery(
