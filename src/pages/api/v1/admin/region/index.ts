...
import { countAll, create, findAllPagination } from '@/query/region'
...
handler
  ...
  .get(async (req, res) => {
    ...
    responsePage(res, 'success', { data: result, meta }, 'get all regional', 200);
  })
  .post(async (req, res) => {
    ...
    response(res, 'success', { data: result }, 'created new regional', 201);
  })
