...
const PengajianAlHidayah = ({ navItem }: Props) => {
  return (
	...
	<div className="flow-root text-justify">
          ...
          <div className="my-2">
                <div className="my-1"><strong> 1. Visi. </strong></div>
				<p> a. Pengurus Pusat : Berkedudukan di Jakarta </p>
				<p> b. Pengurus Daerah : 27 di tk. I, 297 di tk. II c. Pengurus Cabang : 3020 /Kec. </p>
			
				<div className="my-1"><strong> 2. Misi. </strong></div>
				<p> 1. Meningkatkan kualitas sumber daya perempuan Indonesia yang meliputi aspek keagamaan,	pendidikan, kebudayaan dan IPTEK. </p>
				<p> 2. Menggalang dan menggerakan kaum perempuan Indonesia beserta seluruh potensi yang dimilikinya. </p>
				<p> 3. Mengupayakan system kehidupan kemasyarakatan, kebangsaan dan kenegaraan yang menjamin hak – hak asasi perempuan dan keluarga. </p>
				<p> 4. Meningkatkan pemberdayaan kaum perempuan Indonesia di berbagai bidang. </p>
				<p> 5. Mewujudkan kesetaraan dan keadilan gender dalam berkeluarga dan bermasyarakat. </p>
          </div>		  
    </div>
