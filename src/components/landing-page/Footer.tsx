...
const Footer = () => {
  return (
    <footer className="justify-center bg-footer bg-cover bg-center">
      <div className="bg-footer-700 py-6 px-12 md:flex md:items-center md:justify-between">
        <span className="text-black-300 text-sm sm:text-center"></span>
        <div className="self-center">
          © 2022 • Partai Golkar Sarolangun, All right reserved
        </div>
        <div className="mt-4 flex flex-row justify-center space-x-6 md:mt-0">
          <Link href="https://www.facebook.com/mpogolkarsarolangun">
            <a
              target="_blank"
              rel="noopener noreferrer"
              className="text-black-400 hover:text-gray-700"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
