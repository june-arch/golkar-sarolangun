  ...
  return (
    <footer className="bg-white">
      <section className="p-8 space-y-8">
          <h4 className="uppercase text-center">Ikuti Media Informasi Kami Lainnya</h4>
      ...
      <div className="bg-primary py-6 px-8 text-sm text-center md:flex md:items-center md:justify-between">
