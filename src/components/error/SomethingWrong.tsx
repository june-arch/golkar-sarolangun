...
function SomethingWrong() {
  return (
    <div className='bg-gray-100'>
        <div className={` h-screen flex flex-col items-center ${paddingDefault} ${padding}`}>
            <div className="pt-24 flex flex-col items-center">
                ...
                <div className=" tracking-widest mt-4 text-center">
                    <span className="text-gray-500 text-6xl block"><span>Opss !</span></span>
                    <span className="text-gray-500 text-xl">Sorry, Something&apos;s wrong, please try again later!</span>
                </div>
            </div>
            <div className="mt-6">
